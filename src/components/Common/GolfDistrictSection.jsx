  ...
  const features = [
    {
      ...
      desc: 'European Championship Golf reimagined for India.',
      img: 'https://cdn.dellatownships.com/images/della-international-ahmedabad/della-international-golfcourse/della-townships-ahmedabad-international-golf-course-hero.webp',
    },
    {
      id: 2,
      stat: '256',
      ...
      desc: 'Ultra-Premium Sky-homes overlooking the greens.',
      img: 'https://cdn.dellatownships.com/images/della-international-ahmedabad/della-international-golfcourse/golfclub/golfclub-popup-4.webp',
    },
    {
      id: 3,
      stat: '1,028',
      ...
      desc: 'Exclusive living integrated with sculpted fairways.',
      img: 'https://cdn.dellatownships.com/images/della-international-ahmedabad/della-international-golfcourse/golfclub/golfclub-popup-2.webp',
    },
    {
      id: 4,
      stat: '300',
      ...
      desc: 'Destination Weddings, MICE Venues & 5 Restaurants.',
      img: 'https://cdn.dellatownships.com/images/della-international-ahmedabad/della-international-golfcourse/residences/residences-popup-4.webp',
    },
    {
      id: 5,
      stat: '20,000',
      unit: 'sqft',
      title: 'Della Golf Club',
      desc: 'Members-only Golf & Racquet Club with elite performance labs.',
      img: 'https://cdn.dellatownships.com/images/della-international-ahmedabad/della-international-golfcourse/championship-golf/championship-golf-popup-5.webp',
    }
  ];
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="w-full flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6">
          ...
          <div className="flex items-center gap-5 sm:gap-8">
            <span className="text-4xl sm:text-5xl lg:text-6xl font-serif text-[#D4AF37] font-light leading-none">
              02<span className="text-white/20">.</span>
            </span>
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-light font-serif leading-none text-white tracking-wide">
                Championship <span className="italic text-gray-300">Golf Course</span>
              </h2>
            </div>
          </div>
          ...
          <div className="max-w-lg lg:max-w-md xl:max-w-xl lg:border-l border-white/10 lg:pl-8">
            <p className="text-xs sm:text-sm text-gray-400 font-light leading-relaxed tracking-wide">
              The second landmark of Della International City is a 300-acre Championship Golf Course inspired by Europe’s legendary greens. Experience sculpted fairways and Riviera-style contours.
            </p>
          </div>
        ...
        <div className="relative h-[70vh] min-h-[600px] w-full rounded-sm overflow-hidden group/stage shadow-2xl">
          ...
          <div className="absolute top-0 left-0 w-full lg:w-[85%] h-full overflow-hidden bg-[#111]">
            ...
            <div className="hidden lg:block absolute inset-0 bg-gradient-to-l from-[#050505] via-[#050505]/60 to-transparent w-[55%] ml-auto"></div>
          ...
          <div className="absolute bottom-0 lg:bottom-auto lg:top-1/2 lg:-translate-y-1/2 right-0 w-full lg:w-[42%] xl:w-[38%] lg:bg-[#0a0a0a]/70 lg:backdrop-blur-2xl p-6 sm:p-8 lg:p-12 lg:border-r-[3px] lg:border-[#D4AF37] z-20">
            ...
            <p className="text-[#D4AF37] text-[10px] tracking-widest uppercase font-semibold mb-6 hidden lg:block">Township Sector B</p>
            ...
            <div className="flex flex-col gap-5 mt-6 pt-6 lg:mt-8 lg:pt-8 border-t border-white/10">
              ...
              {/* PRIMARY CTA */}
              <a href="/golf-course" className="inline-flex items-center justify-between w-full bg-[#D4AF37] text-black px-6 py-4 rounded-sm group hover:bg-white transition-colors duration-300">
                <span className="text-[10px] sm:text-xs uppercase tracking-[0.2em] font-bold">Explore The Greens</span>
          ...
          {/* Minimalist Gallery Navigation - LEFT ALIGNED */}
          <div className="absolute top-6 left-6 lg:top-auto lg:bottom-8 lg:left-8 flex gap-2 lg:gap-3 z-30">
...
export default GolfDistrictSection;