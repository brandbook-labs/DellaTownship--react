...
const products = [
  { id: 1, name: 'Banarasi Silk Saree with Zari Work', category: 'Sarees', price: 12500, oldPrice: 15000, rating: 5.0, reviews: 112, image: 'https://images.unsplash.com/photo-1610030469983-98e550d615e1?q=80&w=600&auto=format&fit=crop', badge: 'Bestseller' },
  { id: 2, name: 'Embroidered Velvet Bridal Lehenga', category: 'Lehengas', price: 35000, oldPrice: 42000, rating: 4.9, reviews: 48, image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=600&auto=format&fit=crop', badge: 'New' },
  { id: 3, name: 'Cotton Floral Anarkali Suit', category: 'Kurtas', price: 3200, oldPrice: null, rating: 4.7, reviews: 156, image: 'https://images.unsplash.com/photo-1583391733958-d25e0b46410f?q=80&w=600&auto=format&fit=crop' },
  { id: 4, name: 'Kanjeevaram Temple Border Saree', category: 'Sarees', price: 18000, oldPrice: null, rating: 4.8, reviews: 320, image: 'https://images.unsplash.com/photo-1609505848912-b7c3b8b4beda?q=80&w=600&auto=format&fit=crop' },
  { id: 5, name: 'Designer Georgette Gown', category: 'Dresses', price: 8500, oldPrice: 10000, rating: 4.5, reviews: 56, image: 'https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?q=80&w=600&auto=format&fit=crop', badge: 'Sale' },
  { id: 6, name: 'Chanderi Handloom Saree', category: 'Sarees', price: 6500, oldPrice: null, rating: 4.6, reviews: 45, image: 'https://images.unsplash.com/photo-1583391733975-eb76fad0e867?q=80&w=600&auto=format&fit=crop' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-12 transition-all duration-700 ease-out transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl leading-relaxed">
            Explore our exquisite range of handcrafted silk sarees, bridal lehengas, and elegant festive kurtas designed for the modern Indian woman.
          </p>
        </div>
