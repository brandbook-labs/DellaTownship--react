...
const products = [
  { id: 11, name: 'Girls Floral Lehenga Choli', category: 'Girls', price: 2500, oldPrice: 3000, rating: 4.8, reviews: 65, image: 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?q=80&w=600&auto=format&fit=crop', badge: 'New' },
  { id: 12, name: 'Boys Silk Kurta Set', category: 'Boys', price: 2100, oldPrice: null, rating: 4.9, reviews: 88, image: 'https://images.unsplash.com/photo-1519238263530-99bea00402d5?q=80&w=600&auto=format&fit=crop' },
  { id: 13, name: 'Girls Embroidered Sharara', category: 'Girls', price: 3200, oldPrice: null, rating: 4.7, reviews: 34, image: 'https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?q=80&w=600&auto=format&fit=crop' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-12 transition-all duration-700 ease-out transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-4">
            Kids' Festive Collection
          </h1>
          <p className="text-base md:text-lg text-gray-600 max-w-2xl leading-relaxed">
            Adorable, comfortable, and vibrant traditional wear for the little ones to shine in every festivity and wedding function.
          </p>
        </div>
