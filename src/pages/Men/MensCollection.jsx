...
const products = [
  { id: 7, name: 'Classic Silk Kurta Pajama', category: 'Kurtas', price: 4500, oldPrice: 5500, rating: 4.8, reviews: 84, image: 'https://images.unsplash.com/photo-1617137968427-85924c800a22?q=80&w=600&auto=format&fit=crop', badge: 'Popular' },
  { id: 8, name: 'Embroidered Groom Sherwani', category: 'Wedding', price: 28000, oldPrice: null, rating: 4.9, reviews: 22, image: 'https://images.unsplash.com/photo-1598808503746-f34c53b9323e?q=80&w=600&auto=format&fit=crop' },
  { id: 9, name: 'Linen Nehru Jacket Set', category: 'Festive', price: 6500, oldPrice: 7500, rating: 4.7, reviews: 41, image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=600&auto=format&fit=crop' },
  { id: 10, name: 'Cotton Casual Short Kurta', category: 'Casuals', price: 1800, oldPrice: null, rating: 4.5, reviews: 112, image: 'https://images.unsplash.com/photo-1559582798-678dfc71cee4?q=80&w=600&auto=format&fit=crop' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-12 transition-all duration-700 ease-out transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl leading-relaxed">
            Classic and contemporary menswear for every celebration. From tailored Kurta Pajamas to royal Sherwanis and festive jackets.
          </p>
        </div>
