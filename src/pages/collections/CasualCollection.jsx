...
const products = [
  { id: 41, name: 'White Cotton Chikankari Kurti', category: 'Kurtas', price: 1800, oldPrice: 2200, rating: 4.8, reviews: 210, image: 'https://images.unsplash.com/photo-1583391733975-eb76fad0e867?q=80&w=600&auto=format&fit=crop', badge: 'Everyday Essential' },
  { id: 42, name: 'Indigo Block Print Suit Set', category: 'Suit Sets', price: 2400, oldPrice: null, rating: 4.6, reviews: 85, image: 'https://images.unsplash.com/photo-1583391733958-d25e0b46410f?q=80&w=600&auto=format&fit=crop' },
  { id: 43, name: 'Men\'s Linen Blend Short Kurta', category: 'Menswear', price: 1200, oldPrice: 1500, rating: 4.7, reviews: 142, image: 'https://images.unsplash.com/photo-1559582798-678dfc71cee4?q=80&w=600&auto=format&fit=crop' },
  { id: 44, name: 'Pastel Floral Palazzo Set', category: 'Sets', price: 2800, oldPrice: null, rating: 4.9, reviews: 53, image: 'https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?q=80&w=600&auto=format&fit=crop', badge: 'New' },
];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans pt-24 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex text-xs font-medium text-gray-500 mb-8 uppercase tracking-widest">
          ...
          <span className="text-gray-900">Everyday Casuals</span>
        </nav>
        ...
        <div className={`mb-12 transition-all duration-700 ease-out transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-4">Everyday Casuals</h1>
          <p className="text-base md:text-lg text-gray-600 max-w-2xl leading-relaxed">
            Lightweight cottons, breathable linens, and beautiful block prints. Perfect for the office, daily wear, or casual outings.
          </p>
        </div>
