...
const products = [
  { id: 21, name: 'Mustard Yellow Chanderi Suit', category: 'Suit Sets', price: 4500, oldPrice: 5200, rating: 4.8, reviews: 84, image: 'https://images.unsplash.com/photo-1583391733958-d25e0b46410f?q=80&w=600&auto=format&fit=crop', badge: 'Festive Pick' },
  { id: 22, name: 'Emerald Green Silk Saree', category: 'Sarees', price: 9500, oldPrice: 12000, rating: 4.9, reviews: 112, image: 'https://images.unsplash.com/photo-1610030469983-98e550d615e1?q=80&w=600&auto=format&fit=crop' },
  { id: 23, name: 'Men\'s Rose Pink Kurta', category: 'Menswear', price: 2800, oldPrice: null, rating: 4.7, reviews: 45, image: 'https://images.unsplash.com/photo-1559582798-678dfc71cee4?q=80&w=600&auto=format&fit=crop' },
  { id: 24, name: 'Maroon Zari Work Lehenga', category: 'Lehengas', price: 14500, oldPrice: 18000, rating: 4.9, reviews: 67, image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=600&auto=format&fit=crop', badge: 'Bestseller' },
];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans pt-24 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex text-xs font-medium text-gray-500 mb-8 uppercase tracking-widest">
          ...
          <span className="text-gray-900">Festive Wear</span>
        </nav>
        ...
        <div className={`mb-12 transition-all duration-700 ease-out transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-4">Festive Wear</h1>
          <p className="text-base md:text-lg text-gray-600 max-w-2xl leading-relaxed">
            Celebrate in style. Rich colors, intricate zari work, and flowing fabrics designed for poojas, Diwali, and family gatherings.
          </p>
        </div>
